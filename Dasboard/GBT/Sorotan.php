      ...
      <div class="container">
        <div class="page-inner">
          <div class="page-header">
            <h3 class="fw-bold mb-3">Sorotan</h3>
            ...
            <div class="col-md-12">
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <?php
                  include '../../koneksi.php';
                  $sql = "SELECT id, Nama, imgpath, link FROM sorotan";
                      ...
                      <tbody>
                        ...
                        if (mysqli_num_rows($result) > 0) {
                          while ($row = mysqli_fetch_assoc($result)) {
                            ...
                            // Tampilkan gambar dengan modal untuk zoom
                            echo "<td>
                            <img src='../../Assets/Sorotan/" . htmlspecialchars($row['imgpath']) . "' width='100' height='60' alt='Image' 
                                class='img-thumbnail' data-bs-toggle='modal' data-bs-target='#imageModal" . $row['id'] . "'>
                          </td>";

                            echo "<td><a href='" . htmlspecialchars($row['link']) . "' target='_blank'>Lihat</a></td>";
                            echo "<td>
                            <div class='form-button-action'>

                                <a href='delete_sorotan.php?id=". $row['id'] . "' class='btn btn-link btn-danger' title='Delete'>
                        ...
                        <div class='modal-dialog modal-dialog-centered'>
                            <div class='modal-content'>
                                <div class='modal-header'>
                                    <h5 class='modal-title' id='imageModalLabel" . $row['id'] . "'>" . htmlspecialchars($row['Nama']) . "</h5>
                                    <button type='button' class='btn-close' data-bs-dismiss='modal' aria-label='Close'></button>
                                </div>
                                <div class='modal-body text-center'>
                                    <img src='../../Assets/Sorotan/" . htmlspecialchars($row['imgpath']) . "' class='img-fluid' alt='Gambar'>
                                </div>
                            </div>
                        </div>
                    </div>";
