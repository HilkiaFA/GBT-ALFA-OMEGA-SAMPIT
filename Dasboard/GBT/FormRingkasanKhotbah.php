...
if (isset($_GET['id'])) {
    ...
    $sql = "SELECT * FROM ringkasankhotbah WHERE id = $id";
    $result = mysqli_query($conn, $sql);

    if ($result && mysqli_num_rows($result) > 0) {
        $data = mysqli_fetch_assoc($result);
    } else {
        echo "<script>alert('Data tidak ditemukan'); window.location='ringkasankhotbah.php';</script>";
        exit();
    }
} else {
    echo "<script>alert('ID tidak ditemukan'); window.location='ringkasankhotbah.php';</script>";
    exit();
}
?>
                                ...
                                <ul class="nav nav-collapse">
                                    ...
                                    <li>
                                        <a href="../GBT/carousel.php">
                                            <span class="sub-item">Corousel</span>
                                        </a>
                                    </li>
                                    <li class="active">
            ...
            <div class="container">
                <div class="page-inner">
                    <div class="page-header">
                        <h3 class="fw-bold mb-3">Ringkasan Khotbah</h3>
                    ...
                    <div class="row">
                        <div class="container-fluid px-3">
                            <div class="row justify-content-center">
                                <div class="col-md-8 col-lg-12 container-form mt-5">
                                    <h3 class="fw-bold mb-3 text-center">Edit Ringkasan Khotbah</h3>

                                    <form action="proses_ringkasan.php" method="POST">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control" id="ringkasan" name="ringkasan" rows="8" required><?php echo htmlspecialchars($data['Ringkasan']); ?></textarea>
                                        </div>
