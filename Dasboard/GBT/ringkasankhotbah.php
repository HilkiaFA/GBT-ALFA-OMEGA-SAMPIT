            ...
            <div class="col-md-12">
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  $sql = "SELECT id, Nama, Judul, Ringkasan FROM ringkasankhotbah";
                      ...
                      <tbody>
                        ...
                        if (mysqli_num_rows($result) > 0) {
                          while ($row = mysqli_fetch_assoc($result)) {
                            ...
                            echo "<td>" . htmlspecialchars($row['Ringkasan']) . "</td>";
                            echo "<td>
                                    <div class='form-button-action'>
                                      <a href='FormRingkasanKhotbah.php?id=" . $row['id'] . "' class='btn btn-link btn-primary btn-lg' title='Edit'>
