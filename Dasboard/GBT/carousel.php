      ...
      <div class="container">
        <div class="page-inner">
          <div class="page-header">
            <h3 class="fw-bold mb-3">Corousel</h3>
            ...
            <div class="col-md-12">
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  $sql = "SELECT id, nama, imgpath FROM carousel";
                      ...
                      <tbody>
                        ...
                        if (mysqli_num_rows($result) > 0) {
                          ...
                          while ($row = mysqli_fetch_assoc($result)) {
                            ...
                            echo "<td>
                            <img src='../../Assets/carousel/" . htmlspecialchars($row['imgpath']) . "' width='100' height='60' alt='Image' 
                                class='img-thumbnail' data-bs-toggle='modal' data-bs-target='#imageModal" . $row['id'] . "'>
                          </td>";

                            echo "<td>
                            <div class='form-button-action'>
                                <button type='button' class='btn btn-link btn-danger' title='Delete' onclick='hapusData(" . $row['id'] . ")'>
                        ...
                        <div class='modal-dialog modal-dialog-centered'>
                            <div class='modal-content'>
                                ...
                                <div class='modal-body text-center'>
                                    <img src='../../Assets/carousel/" . htmlspecialchars($row['imgpath']) . "' class='img-fluid' alt='Gambar'>
                                </div>
                            </div>
                        </div>
                    </div>";
